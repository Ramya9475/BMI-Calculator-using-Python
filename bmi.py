...
def BMI():
    ...
    #you can change value, because different count have different bmi index
    if bmi<=18.5:
...
#Command to change background colour of the scale
style = ttk.Style()
...
Height = StringVar()
Weight = StringVar()
height = Entry ( root , textvariable = Height , width = 5 , font = "aerial 50" , bg="#fff" , fg="#000",bd=0,justify =CENTER )#to align text to center
height.place(x=35 , y=160)
Height.set(get_current_value())

weight = Entry ( root , textvariable = Weight , width = 5 , font = "aerial 50" , bg="#fff" , fg="#000",bd=0,justify =CENTER )#to align text to center
weight.place(x=255 , y=160)
Weight.set(get_current_value2())

# Labels for Height and Weight
height_label = Label(root, text="Height (cm)", font="arial 12", bg="#ffffff", fg="#000")
height_label.place(x=35, y=130)

weight_label = Label(root, text="Weight (kg)", font="arial 12", bg="#ffffff", fg="#000")
weight_label.place(x=255, y=130)

#man image
secondimage = Label(root , bg="lightblue")
secondimage.place(x= 70 , y =530)

Button(root, text="View Report" , width = 15 , height = 2 , font="aerial 10 bold" , bg="#1f6e68" , fg = "white", command = BMI).place(x=280 , y=340)
